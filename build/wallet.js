...
var findUnspentTxOuts = function (ownerAddress, unspentTxOuts) {
    return lodash_1.default.filter(unspentTxOuts, function (uTxO) { return uTxO.address === ownerAddress; });
};
...
var filterTxPoolTxs = function (unspentTxOuts, transactionPool) {
    var txIns = lodash_1.default(transactionPool)
        .map(function (tx) { return tx.txIns; })
        .flatten()
        .value();
    var removable = [];
    var _loop_1 = function (unspentTxOut) {
        var txIn = lodash_1.default.find(txIns, function (aTxIn) {
    ...
    return lodash_1.default.without.apply(lodash_1.default, [unspentTxOuts].concat(removable));
};
